...
const DeveloperCredit = ({ className }: { className?: string }) => {
  return (
    <footer className={className}>
      <p className="text-center text-sm text-muted-foreground transition-transform duration-300 hover:-translate-y-1 group">
        Proudly Developed by{' '}
        <a
          href="https://github.com/Adil-Munawar-Official"
          target="_blank"
          rel="noopener noreferrer"
          className="font-semibold text-primary/90 group-hover:text-primary transition-colors"
        >
